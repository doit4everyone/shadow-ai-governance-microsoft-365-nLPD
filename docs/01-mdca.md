...
| — | Politique de session pour les transferts de fichiers : **non requise**. La section 1.7.2 est optionnelle et non déployée dans ce guide (elle exige un proxy CAAC absent de cette architecture). Ne cochez cette ligne que si votre organisation exploite déjà un proxy CAAC. | Sans objet |
